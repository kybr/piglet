...
_: flash main test piglet.so

flash: flash.o piglet.o
	cc -o flash -Wl,--whole-archive flash.o piglet.o -L/opt/vc/lib/ -lGLESv2 -lEGL -lbcm_host -lvcos -lvchiq_arm -lpthread -lrt -L/opt/vc/src/hello_pi/libs/vgfont -ldl -lm -Wl,--no-whole-archive -rdynamic
